    ...
    <div class="d-flex" id="wrapper">
        ...
        <nav class="bg-primary" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                <a href="<?php echo e(route('dashboard.index')); ?>" class="list-group-item list-group-item-action bg-primary">
                    <i class="bi bi-speedometer2 me-2"></i> Dashboard
                </a>
                <a href="<?php echo e(route('categories.index')); ?>" class="list-group-item list-group-item-action bg-primary">
                    <i class="bi bi-tags me-2"></i> Categories
                </a>
                <a href="<?php echo e(route('posts.index')); ?>" class="list-group-item list-group-item-action bg-primary">
                    <i class="bi bi-file-text me-2"></i> Posts
                </a>
                <a href="<?php echo e(route('authors.index')); ?>" class="list-group-item list-group-item-action bg-primary">
                ...
                <div class="container text-center">
                    <div class="row">
                        <div class="col-md-6 mb-3 mb-md-0">
                            <p>&copy;  Blog MSIB Tahun Ajaran <?php echo e(date('Y')); ?></p>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\blog_MSIB\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>